    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="/dashboard-admin" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="/dashboard-admin/user" class="side-nav-link">
                    <i class="uil-user"></i>
                    <span> User </span>
                </a>
            </li>
            ...
            <li class="side-nav-item">
                <a href="/dashboard-admin/product" class="side-nav-link">
                    <i class="uil-box"></i>
                    <span> Product </span>
                </a>
            </li>
            ...
            <li class="side-nav-item">
                <a href="/dashboard-admin/category" class="side-nav-link">
        ...
        <div class="help-box text-white text-center">
            ...
            <h5 class="mt-3">Ada Kendala?</h5>
            <p class="mb-3">Hubungi Admin untuk membantu permasalahan anda</p>
            <a href="javascript: void(0);" class="btn btn-secondary btn-sm">Call Admin</a>
        </div>
        <!-- end Help Box -->
        <!-- End Sidebar -->
