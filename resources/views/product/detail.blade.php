      ...
      <section class="mt-8">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="ps-lg-10">
                <a href="/product?search={{ $product->category->name }}" class="mb-4 d-block">{{ $product->category->name }}</a>
                ...
                <div class="fs-4">
                  <span class="fw-bold text-dark">Rp{{ number_format($product->price, 0, ',', '.') }}</span> <span
                    class="text-decoration-line-through text-muted">Rp2M</span><span><small class="fs-6 ms-2 text-danger">94%
                      Off</small></span>
                </div>
                ...
                <div class="mt-5 d-flex justify-content-start">
                  ...
                  <div class="ms-2 col-4">
                    <a class="btn btn-light " href="shop-wishlist.html" data-bs-toggle="tooltip" data-bs-html="true"
                      title="Wishlist"><i class="feather-icon icon-heart"></i></a>
                  </div>
                </div>
